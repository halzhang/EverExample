...
public class StringPicker extends LinearLayout {
    ...
    private final Paint mMiddleItemPaint;
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange(StringPicker picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *                    {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(StringPicker view, int scrollState);
    }
    ...
    public StringPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(
                attrs, R.styleable.PAFFNumberPicker, defStyle, 0);
        final int layoutResId = attributesArray.getResourceId(
                R.styleable.PAFFNumberPicker_internalLayout, DEFAULT_LAYOUT_RESOURCE_ID);

        mHasSelectorWheel = (layoutResId != DEFAULT_LAYOUT_RESOURCE_ID);

        mSolidColor = attributesArray.getColor(R.styleable.PAFFNumberPicker_solidColor, 0);

        mSelectionDivider = attributesArray.getDrawable(R.styleable.PAFFNumberPicker_selectionDivider);
        ...
        mSelectionDividerHeight = attributesArray.getDimensionPixelSize(
                R.styleable.PAFFNumberPicker_selectionDividerHeight, defSelectionDividerHeight);
        ...
        mSelectionDividersDistance = attributesArray.getDimensionPixelSize(
                R.styleable.PAFFNumberPicker_selectionDividersDistance, defSelectionDividerDistance);

        mMinHeight = attributesArray.getDimensionPixelSize(
                R.styleable.PAFFNumberPicker_internalMinHeight, SIZE_UNSPECIFIED);

        mMaxHeight = attributesArray.getDimensionPixelSize(
                R.styleable.PAFFNumberPicker_internalMaxHeight, SIZE_UNSPECIFIED);
        ...
        mMinWidth = attributesArray.getDimensionPixelSize(
                R.styleable.PAFFNumberPicker_internalMinWidth, SIZE_UNSPECIFIED);

        mMaxWidth = attributesArray.getDimensionPixelSize(
                R.styleable.PAFFNumberPicker_internalMaxWidth, SIZE_UNSPECIFIED);
...
//        paint.setColor(color);
        ...
        // create the divider paint
        mDividerPaint = new Paint();
        mDividerPaint.setColor(Color.GRAY);

        // create middle item background paint
        mMiddleItemPaint = new Paint();
        mMiddleItemPaint.setColor(Color.WHITE);
     ...
     * <p>
     * If the argument is less than the {@link StringPicker#getMinValue()} and
     * {@link StringPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link StringPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link StringPicker#getMinValue()} and
     * {@link StringPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link StringPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link StringPicker#getMaxValue()} and
     * {@link StringPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link StringPicker#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link StringPicker#getMinValue()} and
     * {@link StringPicker#getMaxValue()} values.
     * <p>
    ...
    protected void onDraw(Canvas canvas) {
        d("HasSelectorWheel: " + mHasSelectorWheel);
        if (!mHasSelectorWheel) {
            super.onDraw(canvas);
            return;
        }
        super.onDraw(canvas);
        canvas.drawRect(0, mTopSelectionDividerTop, getRight(), mBottomSelectionDividerBottom, mMiddleItemPaint);
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            if (i == SELECTOR_MIDDLE_ITEM_INDEX) {
                mSelectorWheelPaint.setColor(0xff3399ff);
            } else {
                mSelectorWheelPaint.setColor(0xffafafaf);
            }

            d("scrollSelectorValue: " + scrollSelectorValue);
...
//            }
        ...
        if (mSelectionDivider != null) {
            ...
            int topOfTopDivider = mTopSelectionDividerTop;
            int bottomOfTopDivider = topOfTopDivider + mSelectionDividerHeight;
            canvas.drawRect(0, topOfTopDivider, getRight(), bottomOfTopDivider, mDividerPaint);

            // draw bottom divider line
            int bottomOfBottomDivider = mBottomSelectionDividerBottom;
            int topOfBottomDivider = bottomOfBottomDivider - mSelectionDividerHeight;
            canvas.drawRect(0, topOfBottomDivider, getRight(), bottomOfBottomDivider, mDividerPaint);
        }
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                                StringPicker.this.postDelayed(this,
    ...
    private BasePickerAdapter mPickerAdapter;

    /**
     * Set picker data and display adapter
     *
     * @param adapter
     */
    public void setPickerAdapter(BasePickerAdapter adapter) {
        mPickerAdapter = adapter;
        setMinValue(0);
        setMaxValue(adapter.getCount() - 1);
        setWrapSelectorWheel(false);
        String[] displayValues = new String[adapter.getCount()];
        for (int i = 0; i < adapter.getCount(); i++) {
            displayValues[i] = adapter.getText(i);
        }
